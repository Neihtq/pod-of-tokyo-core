...
class TestHttpUtils(unittest.TestCase):
    ...
    def test_join(self):
        self.assertEqual(http_utils.join("http://base.com", "endpoint"), "http://base.com/endpoint")
        self.assertEqual(http_utils.join("http://base.com/", "endpoint"), "http://base.com/endpoint")
    ...
    def test_post(self, mock_post):
        ...
        mock_post.assert_called_once_with("http://base.com/endpoint", json={"key": "value"})
    ...
    def test_put(self, mock_put):
        ...
        mock_put.assert_called_once_with("http://base.com/resource/1", json={"key": "value"})
        self.assertEqual(response, mock_response)
